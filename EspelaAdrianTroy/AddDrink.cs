...
namespace EspelaAdrianTroy
{
    public partial class AddDrink : Form
    {
        ...
        private void Button1_Click(object? sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show(this, "Please enter a drink name.", "Validation", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                return;
            }
            ...
            {
                MessageBox.Show(this, "Please enter a valid price (e.g. 1.50).", "Validation", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                return;
            }
